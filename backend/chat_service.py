...
def build_system_prompt(scope: str, details: dict, course_data: dict, available_subjects: list) -> str:
    ...
    system_prompt = (
        ...
        f"{structure_context}\n"
        "SCHEMAS:\n"
        "- Course Details (Step 2): { \"courseType\": \"...\", \"subject\": \"...\", \"courseName\": \"...\", \"description\": \"...\", \"price\": \"...\", \"duration\": \"...\", \"learningHours\": \"...\", \"requirements\": \"...\", \"level\": \"...\", \"language\": \"...\", \"scriptingLanguage\": \"...\", \"evaluator\": \"...\" }\n"
        ...
        "   - The text inside the \"prompt\" JSON field MUST be formatted with double newlines (\\n\\n) between structural sections so it displays with neat line spacing when rendered in the UI.\n"
        "7. COMPLETE COVERAGE & TITLE PRESERVATION RULE (CRITICAL):\n"
        "   - You MUST generate prompts for EVERY SINGLE module and lesson present in the course structure checklist.\n"
        "   - You MUST copy the EXACT module titles and lesson titles provided in the user prompt without altering, truncating, or renaming any words.\n"
        "   - Do NOT skip any middle lessons and do NOT truncate the JSON array before all lesson items are generated.\n"
        ...
        "- duration: Must be a NUMERIC string representing the total course access period in DAYS (e.g., \"30\" for 30 days, \"90\" for 90 days). Do NOT include \"days\" or \"d\". This is purely course metadata and does NOT affect content generation.\n"
        "- learningHours: Must be a NUMERIC string representing the total instructional content hours (1–20, e.g., \"5\" for 5 hours). Suggest based on topic complexity: simple topics 1–3, standard topics 5–8, advanced/comprehensive topics 10–20. Do NOT include \"hours\" or \"hrs\". This is the ONLY value that controls content depth.\n"
